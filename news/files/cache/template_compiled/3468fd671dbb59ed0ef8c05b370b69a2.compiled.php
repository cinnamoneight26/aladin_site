...
<ul class="x_nav x_nav-tabs">
	<li<?php if($__Context->act=='dispDocumentAdminList'){ ?> class="x_active"<?php } ?>><a href="<?php echo getUrl('', 'module', 'admin', 'act', 'dispDocumentAdminList') ?>"><?php echo $__Context->lang->document_list ?></a></li>
	<li<?php if($__Context->act=='dispDocumentAdminConfig'){ ?> class="x_active"<?php } ?>><a href="<?php echo getUrl('', 'module', 'admin', 'act', 'dispDocumentAdminConfig') ?>"><?php echo $__Context->lang->cmd_document_config ?></a></li>
	<li<?php if($__Context->act=='dispDocumentAdminDeclared'){ ?> class="x_active"<?php } ?>><a href="<?php echo getUrl('', 'module', 'admin', 'act', 'dispDocumentAdminDeclared') ?>"><?php echo $__Context->lang->cmd_declared_list ?></a></li>
</ul>
