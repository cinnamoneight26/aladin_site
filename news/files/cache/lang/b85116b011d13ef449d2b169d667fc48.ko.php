...
$lang->msg_php_warning_notice_explain='<li>매우 심각한 PHP 보안 문제 및 공격에 노출될 수 있습니다.</li><li>XE 최신 버전을 사용할 수 없습니다.</li><li>XE 최신 버전 이상에서 지원하는 확장 기능을 사용할 수 없습니다.</li><li>일부 확장 기능이 동작하지 않거나, 이로 인해 장애가 발생할 수 있습니다.</li>';
...
$lang->admin_check_env='서버 환경 확인';
$lang->admin_use_condition_enable='사용이 가능합니다.';
$lang->admin_use_condition_disable='사용이 불가능합니다. 위 사항을 수정하신 후 사용해 주십시오.';
